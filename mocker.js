...
generateFromTemplate = function(template, options, name) {
    var options = options || {};
    useRandom = options.random || true; //Determines use of psuedo-random or Math.random
    ...
    switch (type(template)) {
        ...
        case 'object':
            ...
            for (var p in template) {
                generated[p.replace(/\|(\d+-\d+|\+\d+)/, '')] = generateFromTemplate(template[p], options, p);
